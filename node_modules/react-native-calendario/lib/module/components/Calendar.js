...
const Calendar = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const [lastViewableIndex, setLastViewableIndex] = useState(INITIAL_LIST_SIZE + viewableRangeOffset);
  const {
    months,
  ...
  const firstMonthIndex = useMemo(() => {
    if (localStartDate) {
      const monthIndex = getMonthIndex(firstMonthToRender, localStartDate, months, numberOfMonths);
